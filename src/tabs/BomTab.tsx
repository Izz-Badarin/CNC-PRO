...
import { allParts, bandingByMaterial, columnFaceWidth, columnLayout, doorDims, effectiveHingeCount, generatePanelParts, glassDoorRefs, kickH, stackOn, stackedHeights, columnHasDrawers, type RotationOverrides, type SizeOverrides, type SkipNestOverrides } from "../lib/model";
...
export function BomTab({ cabinets, settings, panels = [], grain = {}, rotation = {}, skipNest = {}, sizeOverride = {}, project = null, customers = null }: Props) {
  ...
  const fullReport = (print = false) => {
    ...
    const html = bomReportHtml(cabinets, settings, panels, grain, project, customers ?? undefined, { screenshotDataUrl: shot }, rotation, skipNest, sizeOverride);
