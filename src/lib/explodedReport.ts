...
function buildExplodeParts(cab: Cabinet, S: Settings): XpPart[] {
  const T = S.bodyThk;
  // back thickness: thin veneer sheet, or full carcass plywood when this
  // cabinet's back is switched to plywood (matches the generated Back part)
  const BT = backThkOf(cab, S);
